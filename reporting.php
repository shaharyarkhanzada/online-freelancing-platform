...
<?php include_once('includes/header.php') ?>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-12"><img class="img-fluid rounded mb-4 mb-lg-0" src="assets/1.jpg" alt="..." /></div>
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-12 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Online job post</h2>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><textarea class="form-control" required name="location"></textarea></td>
          ...
          <tr>
              <th>write full job descrition</th>
